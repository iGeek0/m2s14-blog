        ...
        <main className="container">
            <div className="p-4 p-md-5 mb-4 rounded text-bg-dark">
                <div className="col-md-6 px-0">
                    ...
                    <p className="lead mb-0"><a href="https://www.google.com/" className="text-white fw-bold">Continue reading...</a></p>
                </div>
            </div>
                ...
                <div className="col-md-6">
                    <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div className="col p-4 d-flex flex-column position-static">
                            ...
                            <a href="https://www.google.com/" className="stretched-link">Continue reading</a>
                        </div>
            ...
            <div className="row g-5">
                <div className="col-md-8">
                    ...
                    <article className="blog-post">
                        ...
                        <p className="blog-post-meta">January 1, 2021 by <a href="https://www.google.com/">Mark</a></p>
                    ...
                    <article className="blog-post">
                        ...
                        <p className="blog-post-meta">December 23, 2020 by <a href="https://www.google.com/">Jacob</a></p>
                        <p>This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing, so be on the lookout for this exact same string of text.</p>
                        <blockquote>
                    ...
                    <article className="blog-post">
                        ...
                        <p className="blog-post-meta">December 14, 2020 by <a href="https://www.google.com/">Chris</a></p>
                        <p>This is some additional paragraph placeholder content. It has been written to fill the available space and show how a longer snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing, so be on the lookout for this exact same string of text.</p>
                        <ul>
                            <li>First list item</li>
                            <li>Second list item with a longer description</li>
                    ...
                    <nav className="blog-pagination" aria-label="Pagination">
                        <a className="btn btn-outline-primary rounded-pill" href="https://www.google.com/">Older</a>
                ...
                <div className="col-md-4">
                    <div className="position-sticky" style={{ top: '2rem' }}>
                        ...
                        <VerticalMenu menu={objectMeses} />
                        <VerticalMenu menu={objectRedes} />
                    </div>
                </div>
            </div>
        </main>
